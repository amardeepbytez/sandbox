...
// const logo2x = require('../assests/img/logo@2x.png')
// const logoLight = require('../assests/img/logo-light.png')
// const logoLight2x = require('../assests/img/logo-light@2x.png')
        ...
        <div className="container flex-lg-row flex-nowrap align-items-center">
            ...
            <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100">
              <ul className="navbar-nav">
                <li className="nav-item dropdown dropdown-mega">
                  <Link className="nav-link dropdown-toggle" to="/" data-bs-toggle="dropdown">Demos</Link>
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li className="dropdown dropdown-submenu dropend"><Link className="dropdown-item dropdown-toggle" to='/' data-bs-toggle="dropdown">Services</Link>
                      <ul className="dropdown-menu">
                        <li className="nav-item"><Link className="dropdown-item" to="./services.html">Services I</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./services2.html">Services II</Link></li>
                      </ul>
                    </li>
                    <li className="dropdown dropdown-submenu dropend"><Link className="dropdown-item dropdown-toggle" to='/' data-bs-toggle="dropdown">About</Link>
                      <ul className="dropdown-menu">
                        <li className="nav-item"><Link className="dropdown-item" to="./about.html">About I</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./about2.html">About II</Link></li>
                      </ul>
                    </li>
                    <li className="dropdown dropdown-submenu dropend"><Link className="dropdown-item dropdown-toggle" to='/' data-bs-toggle="dropdown">Shop</Link>
                      <ul className="dropdown-menu">
                        <li className="nav-item"><Link className="dropdown-item" to="./shop.html">Shop I</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./shop2.html">Shop II</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./shop-product.html">Product Page</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./shop-cart.html">Shopping Cart</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./shop-checkout.html">Checkout</Link></li>
                      </ul>
                    </li>
                    <li className="dropdown dropdown-submenu dropend"><Link className="dropdown-item dropdown-toggle" to='/' data-bs-toggle="dropdown">Contact</Link>
                      <ul className="dropdown-menu">
                        <li className="nav-item"><Link className="dropdown-item" to="./contact.html">Contact I</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./contact2.html">Contact II</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./contact3.html">Contact III</Link></li>
                      </ul>
                    </li>
                    <li className="dropdown dropdown-submenu dropend"><Link className="dropdown-item dropdown-toggle" to='/' data-bs-toggle="dropdown">Career</Link>
                      <ul className="dropdown-menu">
                        <li className="nav-item"><Link className="dropdown-item" to="./career.html">Job Listing I</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./career2.html">Job Listing II</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./career-job.html">Job Description</Link></li>
                      </ul>
                    </li>
                    <li className="dropdown dropdown-submenu dropend"><Link className="dropdown-item dropdown-toggle" to='/' data-bs-toggle="dropdown">Utility</Link>
                      <ul className="dropdown-menu">
                        <li className="nav-item"><Link className="dropdown-item" to="./404.html">404 Not Found</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./page-loader.html">Page Loader</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./signin.html">Sign In I</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./signin2.html">Sign In II</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./signup.html">Sign Up I</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./signup2.html">Sign Up II</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./terms.html">Terms</Link></li>
                      </ul>
                    </li>
                    <li className="nav-item"><Link className="dropdown-item" to="./pricing.html">Pricing</Link></li>
                    <li className="nav-item"><Link className="dropdown-item" to="./onepage.html">One Page</Link></li>
                  </ul>
                </li>
                <li className="nav-item dropdown">
                  <Link className="nav-link dropdown-toggle" to="#" data-bs-toggle="dropdown">Projects</Link>
                  <div className="dropdown-menu dropdown-lg">
                    <div className="dropdown-lg-content">
                      <div>
                        <h6 className="dropdown-header">Project Pages</h6>
                        <ul className="list-unstyled">
                          <li><Link className="dropdown-item" to="./projects.html">Projects I</Link></li>
                          <li><Link className="dropdown-item" to="./projects2.html">Projects II</Link></li>
                          <li><Link className="dropdown-item" to="./projects3.html">Projects III</Link></li>
                          <li><Link className="dropdown-item" to="./projects4.html">Projects IV</Link></li>
                        </ul>
                      </div>
                      {/* <!-- /.column --> */}
                      <div>
                        ...
                        <ul className="list-unstyled">
                          <li><Link className="dropdown-item" to="./single-project.html">Single Project I</Link></li>
                          <li><Link className="dropdown-item" to="./single-project2.html">Single Project II</Link></li>
                          <li><Link className="dropdown-item" to="./single-project3.html">Single Project III</Link></li>
                          <li><Link className="dropdown-item" to="./single-project4.html">Single Project IV</Link></li>
                        </ul>
                      </div>
                      {/* <!-- /.column --> */}
                    </div>
                ...
                <li className="nav-item dropdown">
                  <Link className="nav-link dropdown-toggle" to="#" data-bs-toggle="dropdown">Blog</Link>
                  <ul className="dropdown-menu">
                    <li className="nav-item"><Link className="dropdown-item" to="./blog.html">Blog without Sidebar</Link></li>
                    <li className="nav-item"><Link className="dropdown-item" to="./blog2.html">Blog with Sidebar</Link></li>
                    <li className="nav-item"><Link className="dropdown-item" to="./blog3.html">Blog with Left Sidebar</Link></li>
                    <li className="dropdown dropdown-submenu dropend"><Link className="dropdown-item dropdown-toggle" to='/' data-bs-toggle="dropdown">Blog Posts</Link>
                      <ul className="dropdown-menu">
                        <li className="nav-item"><Link className="dropdown-item" to="./blog-post.html">Post without Sidebar</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./blog-post2.html">Post with Sidebar</Link></li>
                        <li className="nav-item"><Link className="dropdown-item" to="./blog-post3.html">Post with Left Sidebar</Link></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li className="nav-item dropdown dropdown-mega">
                  <Link className="nav-link dropdown-toggle" to="#" data-bs-toggle="dropdown">Blocks</Link>
                  <ul className="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
                    <li className="mega-menu-content">
                      <ul className="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-6 gy-lg-4 list-unstyled">
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/about.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/blog.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/call-to-action.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/clients.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/contact.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/facts.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/faq.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/features.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/footer.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/hero.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/misc.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/navbar.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/portfolio.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/pricing.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/process.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/team.html">
                        ...
                        <li className="col"><Link className="dropdown-item" to="./docs/blocks/testimonials.html">
                ...
                <li className="nav-item dropdown dropdown-mega">
                  <Link className="nav-link dropdown-toggle" to="/" data-bs-toggle="dropdown">Documentation</Link>
                      ...
                      <div className="row gx-0 gx-lg-3">
                        <div className="col-lg-4">
                          ...
                          <ul className="list-unstyled cc-2 pb-lg-1">
                            <li><Link className="dropdown-item" to="./docs/index.html">Get Started</Link></li>
                            <li><Link className="dropdown-item" to="./docs/forms.html">Forms</Link></li>
                            <li><Link className="dropdown-item" to="./docs/faq.html">FAQ</Link></li>
                            <li><Link className="dropdown-item" to="./docs/changelog.html">Changelog</Link></li>
                            <li><Link className="dropdown-item" to="./docs/credits.html">Credits</Link></li>
                          </ul>
                          <h6 className="dropdown-header mt-lg-6">Styleguide</h6>
                          <ul className="list-unstyled cc-2">
                            <li><Link className="dropdown-item" to="./docs/styleguide/colors.html">Colors</Link></li>
                            <li><Link className="dropdown-item" to="./docs/styleguide/fonts.html">Fonts</Link></li>
                            <li><Link className="dropdown-item" to="./docs/styleguide/icons-svg.html">SVG Icons</Link></li>
                            <li><Link className="dropdown-item" to="./docs/styleguide/icons-font.html">Font Icons</Link></li>
                            <li><Link className="dropdown-item" to="./docs/styleguide/illustrations.html">Illustrations</Link></li>
                            <li><Link className="dropdown-item" to="./docs/styleguide/backgrounds.html">Backgrounds</Link></li>
                            <li><Link className="dropdown-item" to="./docs/styleguide/misc.html">Misc</Link></li>
                          </ul>
                        </div>
                        {/* <!--/column --> */}
                        <div className="col-lg-8">
                          ...
                          <ul className="list-unstyled cc-3">
                            <li><Link className="dropdown-item" to="./docs/elements/accordion.html">Accordion</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/alerts.html">Alerts</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/animations.html">Animations</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/avatars.html">Avatars</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/background.html">Background</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/badges.html">Badges</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/buttons.html">Buttons</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/card.html">Card</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/carousel.html">Carousel</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/dividers.html">Dividers</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/form-elements.html">Form Elements</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/image-hover.html">Image Hover</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/image-mask.html">Image Mask</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/lightbox.html">Lightbox</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/player.html">Media Player</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/modal.html">Modal</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/pagination.html">Pagination</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/progressbar.html">Progressbar</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/shadows.html">Shadows</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/shapes.html">Shapes</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/tables.html">Tables</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/tabs.html">Tabs</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/text-animations.html">Text Animations</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/text-highlight.html">Text Highlight</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/tiles.html">Tiles</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/tooltips-popovers.html">Tooltips & Popovers</Link></li>
                            <li><Link className="dropdown-item" to="./docs/elements/typography.html">Typography</Link></li>
                          </ul>
                        </div>
                        {/* <!--/column --> */}
                      </div>
              ...
              <div className="offcanvas-footer d-lg-none">
                <div>
                  <Link to="/" className="link-inverse">info@email.com</Link>
          ...
          <div className="navbar-other w-100 d-flex ms-auto">
            <ul className="navbar-nav flex-row align-items-center ms-auto">
              <li className="nav-item"><Link className="nav-link" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-info"><i className="uil uil-info-circle"></i></Link></li>
              <li className="nav-item"><Link className="nav-link" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-search"><i className="uil uil-search"></i></Link></li>
